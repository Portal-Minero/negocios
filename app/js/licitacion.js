...
function aplica_filtro_superior(){
	alert(12);
			  ...
			  /*llama a la funcion que crea los id de la niea */
						  ...
						  var select_get_sector= $("#select_get_sector").val();
						  var select_get_empresa_lici= $("#select_get_empresa_lici").val();
						  var select_get_u_pais= $("#select_get_u_pais").val();
						  var select_get_u_region= $("#select_get_u_region").val();
						  var select_get_reg_re= $("#select_get_reg_re").val();
						  var get_licitaciones_tipos= $("#select_get_obras_principales").val();
						  
						  var tipo_lici =  $("#tipo_lici").val();
